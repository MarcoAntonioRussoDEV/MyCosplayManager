package com.cosplayinventory.backend.scheduler;
...
import com.cosplayinventory.backend.service.ExpiryCalculationService;
import com.cosplayinventory.backend.service.PushNotificationService;
...
public class ExpiryNotificationScheduler {
    ...
    @Scheduled(cron = "${cosplayinventory.notification.scan-cron}")
    @Transactional
    public void run() {
